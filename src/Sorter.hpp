...
/*
    static void bubble_sort_list(ListSequence<T>* list, bool (*cmpf)(T, T)) {
        list->set_head(bubble_sort_list_primary(list->get_head(), cmpf));
    }
*/
...
// ----------------------------------- BUBBLE SORT LIST -----------------------------------
/*
    static node<T>* bubble_sort_list_primary(node<T>* head, bool (*cmpf)(T, T)) {
        node<T>* 
